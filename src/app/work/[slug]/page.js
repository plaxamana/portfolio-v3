...
export default async function Page({ params }) {
  ...
  return (
    <Section
      className={clsx(
        'grid gap-y-8 max-w-screen-sm mx-auto lg:grid-cols-2 lg:mx-0 lg:max-w-full lg:gap-x-12 lg:gap-y-16',
      )}
    >
      <div>
        <PageTitle
          ...
          containerClassName={clsx('!items-start')}
          imgClassName={clsx('hidden')}
        />
        <div className={clsx('prose text-balance max-w-xl')}>
      ...
      <Image
        ...
        height={433}
      />
      <div className={clsx('flex flex-col gap-y-4 text-balance max-w-xl')}>
      ...
      <div className={clsx('flex flex-col gap-y-4 max-w-xl text-balance')}>
